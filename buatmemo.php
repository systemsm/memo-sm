...
ob_start();
$user = array();
$versi = isset( $_REQUEST['webinterface'] ) ? $_REQUEST['webinterface'] : 'mobile' ;
if (  $versi === 'desktop' ) {
$desktop  = true;
}  else {
  $desktop  = false;
...
<?php } else { 
 //header('Location: ' . filter_var( echo UserService::createLoginURL('') , FILTER_SANITIZE_URL));
?>
  <div class="module">
...
<?php } 
 ...
 ?>	
	<div class="moduletable">
		<?php  
			include_once('isibuatmemo.php');
		?>							
	</div>
	<div >
		<div>&copy; 2013 SIANTAR MADJU,PT</div>
		<div><?php echo 'versi :' .$versi; ?></div>
		<div>2013.6.1</div>
	</div>
	<form action="buatmemo.do" method="post" id ="setform" name="setform" >
	<table>
	  <tr>              
		<td>
		  <INPUT type="radio" name="webinterface" value="desktop">Desktop
		  <INPUT type="radio" name="webinterface" value="mobile">Mobile
